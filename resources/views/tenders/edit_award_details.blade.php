        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              ...
              <form action="{{route('edit_award_details_data', $tender->id)}}" method="post" id="myForm">@csrf
            </div>
            <div class="card-body">
            <div class="row">
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-sm-3">
                  ...
                  <input type="text" class="form-control" placeholder="DD/MM/YYYY" name="date_of_start" value="{{$tender->date_of_start}}">
                </div>     
                <div class="form-group col-sm-3">
                  <label for="inputStatus">Date of Completion</label>
                  <input type="text" class="form-control" placeholder="DD/MM/YYYY" name="date_of_completion" value="{{$tender->date_of_start}}">
                </div>
                <div class="form-group col-sm-3">
                  <label for="inputName">Date of Start(As per Agreement)</label>
                  <input type="text" class="form-control" placeholder="DD/MM/YYYY" name="date_of_start_agreement" value="{{$tender->date_of_start_agreement}}">
                </div>     
                <div class="form-group col-sm-3">
                  <label for="inputStatus">Date of Completion(As per Agreement)</label>
                  <input type="text" class="form-control" placeholder="DD/MM/YYYY" name="date_of_completion_agreement" value="{{$tender->date_of_completion_agreement}}">
                </div>
              </div>  
              <div class="row">
                 <div class="form-group col-sm-3">
                  <label for="inputStatus">Tendered Amount</label>
                  <input type="text" class="form-control" placeholder="Tendered Amount" name="tendered_amount" value="{{$tender->tendered_amount}}">
                </div>
                <div class="form-group col-sm-3">
                  <label for="inputStatus">Percentage(%) Below</label>
                  <input type="text" class="form-control" placeholder="Percentage(%) Below" name="percent_below" value="{{$tender->percent_below}}">
                </div>
                <div class="form-group col-sm-6">
                  <label for="inputName">Time Period</label>
                    <input type="text" class="form-control" placeholder="Time Period" name="time_period" value="{{$tender->time_period}}">
                </div>     
              </div>  
               <div class="row">
                <div class="form-group col-sm-6">
                  <label for="inputName">Remarks</label>
                    <input type="text" class="form-control" placeholder="Remarks" name="remarks" value="{{$tender->remarks}}">
                </div> 
                 <div class="form-group col-sm-6">
